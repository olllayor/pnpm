...
export { checkLocalTarballDepsAreUpToDate, type CheckLocalTarballDepsResult, findPackageTarballIntegrityMismatch, localTarballDepsAreUpToDate, resolveLocalTarballPath } from './localTarballDepsAreUpToDate.js'
